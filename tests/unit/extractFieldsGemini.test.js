...
const extractFieldsGemini_1 = require("../../src/extractors/extractFieldsGemini");
describe('extractShowFields', () => {
    ...
    `;
        const result = await (0, extractFieldsGemini_1.extractShowFields)(mockHtml, 'http://test-gallery.com');
    ...
    it('should handle JSON wrapped in markdown code blocks', async () => {
        ...
        mockGenerateContent.mockResolvedValueOnce(mockResponse);
        const result = await (0, extractFieldsGemini_1.extractShowFields)('<div>test</div>', 'http://test.com');
    ...
    it('should handle missing fields gracefully', async () => {
        ...
        mockGenerateContent.mockResolvedValueOnce(mockResponse);
        const result = await (0, extractFieldsGemini_1.extractShowFields)('<div>Minimal content</div>', 'http://test.com');
    ...
    it('should throw error on Gemini API failure', async () => {
        ...
        await expect((0, extractFieldsGemini_1.extractShowFields)('<div>test</div>', 'http://test.com'))
            .rejects
